...
//            startActivity(intent);
        ...
        Fragment menuFrag  = new MenuBot();
        fragTrans.add(R.id.menuContainerBot, menuFrag).commit();
    }
